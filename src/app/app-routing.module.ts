...
const routes: Routes = [
  ...
  {path: 'home', component: HomeComponent, title: 'Startseite', canActivate: [AuthGuard]},
  {path: 'company', component: CompanyComponent, title: 'Unternehmen', canActivate: [AuthGuard]},
  {path: 'student', component: StudentComponent, title: 'Studenten', canActivate: [AuthGuard]},
